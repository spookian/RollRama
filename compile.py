...
LD_FILES 	= " SequenceTiltStart.o SceneStart.o Chowder.o PlayerController.o StageController.o SimpleRigidbody.o ResFileHelper.o SphereCollider.o PointStar.o WPADReader.o StageLoader.o GXReimplementation.o console_font_8x16.o FakeWriter.o SceneFakeout.o"
